        ...
        <tr>
          <td width="100%" align="center" style="padding: 10px 0">
            ...
            <a name="" href="{{ asset('images/scanify_logo.png') }}" target="_blank">
                <img  alt="[Image: Logo]" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/scanify_logo.png'))) }}">
                ...
                <tr>
                  <td align="center">
                    <!-- <td valign="middle" align="center" width="50%" style="padding-left: 60px;"
                                              class="banner_side"> -->
                    <!-- Banner Logo -->
                    <a name="" href="{{ asset('images/report-asset.png') }}" target="_blank">
                        <img alt="[Image: Regenerate]" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/report-asset.png'))) }}">
                    ...
                    >
                      <div class="">
                        ...
                        <p
                          ...
                          "
                        >
                          This is to inform you that the following asset had been
                          reported.
                        </p>
                      </div>
                    </div>
              ...
              <tbody>
                ...
                <tr>
                  <td
                    ...
                    "
                  >
                    Report Detail: The logo appears outdated and does not match
                    the current brand guidelines. Suggest replacing with the
