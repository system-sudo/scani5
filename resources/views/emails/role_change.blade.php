            ...
            <tbody>
              <tr>
                <td align="center" style="padding: 0 0 0 0">
                  <!-- <td valign="middle" align="center" width="50%" style="padding-left: 60px;"
                                            class="banner_side"> -->
                  <!-- Banner Logo -->
                  <a name="" href="{{ asset('images/role-change.png') }}" target="_blank">
                    <img alt="[Image: Role]" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/role-change.png'))) }}">
              ...
              <tr>
                <td valign="middle" align="center" width="50%" class="title">
                  ...
                  >
                    <div class="">
                      <h4 style="margin: 0" align="left">Hello,</h4>
                      <p
                        class="mail-title"
                        style="
                          white-space: nowrap;
                        ...
                        "
                      >
                        Your Role has been changed by admin.
                      </p>
                    </div>
                    <div
                      style="
            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  ...
                  <a href="mailto:support@sq1.security" style="color: #7a69ee">support@sq1.security</a>
                </td>
              </tr>
              <tr></tr>
